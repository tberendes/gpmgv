...
\copy dbzdiff_stats_s2kuAGL from '/data/tmp/StatsByDistToDBGeo_AGLMSLfixS2Ku.unl' with delimiter '|' 
...
\copy dbzdiff_stats_defaultAGL from '/data/tmp/StatsByDistToDBGeo_AGLMSLfixAllDefaults.unl' with delimiter '|' 
...
\copy dbzdiff_stats_prrawcorAGL from '/data/tmp/StatsByDistToDBbyGeo_PRx2AGL.unl' with delimiter '|' 
