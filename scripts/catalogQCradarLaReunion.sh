...
################################################################################
#
#  catalogQCradarLaReunion.sh     Morris/SAIC/GPM GV     Jan 2016
#
#  DESCRIPTION
#    
...
LOG_FILE=${LOG_DIR}/catalogQCradarLaReunion.${rundate}.log
...
echo "=====================================================" | tee $LOG_FILE
echo " Catalog any La Reunion final QC radar files as of " | tee -a $LOG_FILE
