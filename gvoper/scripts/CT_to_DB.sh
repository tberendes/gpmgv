...
#
# Process table in TSDIS/PPS legacy Coincidence File into a delimited format
# ready to be loaded into database (PostGRESQL), spreadsheet etc. 
# Use '|' as delimiters.
#
# Files:
#   CT.yymmdd.6 or CT.yyyymmdd.7      (input; yymmdd varies by date)
#   CT.yymmdd.unl               (output; delimited fields, stripped of headings)
#
################################################################################
...
# sed command 6: delete all lines where radar ID is 'KORA'
# sed command 7: append time zone ID "+00" to end of datetime string
