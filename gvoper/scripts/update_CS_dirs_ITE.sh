...
################################################################################
#
# update_CS_dirs_ITE.sh      Morris/GPM GV/SAIC     March 2015
#
...
#
# Should be able to handle any new ITE versions (ITE001-ITE999).
#
#  HISTORY
...
#    04/27/17      - Morris - Created (copied) from update_CS_dirs_v4test.sh
