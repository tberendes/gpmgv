...
; the PARAMETER_SET variable in the matchup script do_DPR_GeoMatch.sh.
;
...
;           DBZ_MIN=15.0,  DPR_DBZ_MIN=15.0, DPR_RAIN_MIN=0.01, NC_NAME_ADD='15dbzGRDPR_newDm', $
;resolve_all
