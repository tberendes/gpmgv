...
;         speed up processing of scans, do nearest-neighbor analyses, made into an
;         IDL function.
;+

function access2A25, file_2a25, unlout=UNLOUT, Height=height, nAvgHeight=hh, $
...
if ( status NE 'OK' ) then begin
   print, "*****************************************************"
   print, "In access2a25, read_2a25_ppi status = ", status
...
print, format='("Processing metadata for ",a0,", event_num ",i0)', $
