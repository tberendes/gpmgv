...
;
;-------------------------------------------------------------------------------
; getmetadata2adpr.pro    Bob Morris, GPM GV (SAIC)    March 2014
;
; DESCRIPTION
;
...
;        reinitialize the common variables and call extract2ADPRmeta to extract
...
;         END_SAMPLE=0
         ...
         status = extract2ADPRmeta( file_2do, Instrument, dist, unlunit )

         if ( status NE 'OK' ) then begin
           print, "In getmetadata2aDPR.pro, error in processing ", file_2do
         endif
...
;print
;print, "getMetadata2ADPR elapsed time in seconds: ", SYSTIME(1) - Tbegin
print
