...
;-------------------------------------------------------------------------------
;
; gen_dprgmi_geo_match_netcdf_v7.pro    Bob Morris, GPM GV (SAIC)    May 2014
;
; DESCRIPTION:
...
fpdimid = [ fpdimid_FS, fpdimid_NS ]                    ; match to "swath" array, above
...
nKuKa_dimid = ncdf_dimdef(cdfid, 'nKuKa', nKuKa)    ; no. of Ku and Ka for some FS swath vars.
...
timedimid = [ timedimid_FS, timedimid_NS ]                      ; match to "swath" array, above
...
; are there any FS scan points in the GR range limit?
...
;TAB 10/26/20 added new variables, need to check units
   ...
   IF ( swath[iswa] EQ 'FS' ) THEN BEGIN
     ; include the extra dimension "nKuKa" for FS swath
