...
@dpr_geo_match_nc_structs_v7.inc
   ...
   if SAMPLE_RANGE ne numDPRScans then begin
   	   message, 'dpr2gr_prematch: numDPRScans '+numDPRScan+' doesn't match product scans '+SAMPLE_RANGE
	   for ifp = 0, numDPRrays-1 do begin
	      ...
	      message, 'DPR scan '+scan_num+' -> '+min_scan
	      message, 'DPR ray '+ray_num+' -> '+min_ray
	      message, 'distance '+min_dist
