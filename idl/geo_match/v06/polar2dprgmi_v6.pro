...
; All Rights Reserved.
;
; polar2dprgmi_v6.pro          Morris/SAIC/GPM_GV      May 2014
;
; DESCRIPTION
; -----------
...
PRO polar2dprGMI_v6, control_file, range_threshold_km, GPM_ROOT=gpmroot, $
...
;   DPR_scantype = parsed[6]        ; HS, MS, or NS
  ...
  ; so that it can become part of the matchup file name
   throwaway = gen_dprgmi_geo_match_netcdf_v6( GEO_MATCH_VERS=matchup_file_version )
...
;         stop
  ...
  ; generate the netcdf matchup file path/name
   ...
   ; gen_dprgmi_geo_match_netcdf_v6()
  ...
  ; attribute values along
   ...
   ncfile = gen_dprgmi_geo_match_netcdf_v6( fname_netCDF, num_fp_by_source[0],     $
...
;***********                                   
  ...
  ; in code in a separate file, included below:
   ...
   @polar2dprgmi_resampling_v6.pro
