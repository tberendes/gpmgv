...
; All Rights Reserved.
;
; polar2dprgmi.pro          Morris/SAIC/GPM_GV      May 2014
;
; DESCRIPTION
; -----------
...
;    file version, rather than gen_dprgmi_geo_match_netcdf.
...
PRO polar2dprGMI, control_file, range_threshold_km, GPM_ROOT=gpmroot, $
...
;   DPR_scantype = parsed[6]        ; HS, MS, or NS
  ...
  ; so that it can become part of the matchup file name
   throwaway = gen_dprgmi_geo_match_netcdf( GEO_MATCH_VERS=matchup_file_version )
...
;   idx_uniq_elevs = UNIQ(elev_angle)
  ...
  ; attribute values along
   ...
   ncfile = gen_dprgmi_geo_match_netcdf( fname_netCDF, num_fp_by_source[0],     $
