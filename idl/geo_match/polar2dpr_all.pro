...
; All Rights Reserved.
;
; polar2dpr_all.pro          Morris/SAIC/GPM_GV      Mar 2017
;
; DESCRIPTION
; -----------
...
;
; 03/29/17 by Bob Morris, GPM GV (SAIC)
;  - CREATED from polar2dpr.pro.  Modified to compute matchups for all DPR rays
;    in the overlap area, regardless of the presence of echoes above the
;    dpr_dbz_min threshold.
;
...
PRO polar2dpr_all, control_file, range_threshold_km, GPM_ROOT=gpmroot, $
               DIRDPR=dir2adpr, DIRKU=dir2aku, DIRKA=dir2aka, DIRCOMB=dircomb, $
               DIRGV=dirgv, SCORES=run_scores, PLOT_PPIS=plot_PPIs, $
               PLOT_BINS=plot_bins, NC_DIR=nc_dir, NC_NAME_ADD=ncnameadd, $
               MARK_EDGES=mark_edges, DPR_DBZ_MIN=dpr_dbz_min, DBZ_MIN=dBZ_min, $
...
; IGNORE ALL THAT AND JUST SET UP TO DO ALL DPR RAYS WITHIN RANGE
            dpr_echoes[numDPRrays] = 1B
