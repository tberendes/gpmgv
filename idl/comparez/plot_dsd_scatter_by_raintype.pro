...
;                            GR_DM_D0=GR_DM_D0
;
;       Internal Module: plot_dsd_scat, pos, sub_title, siteID, ncolor, charsz, $
...
;       - Changed name of plot_scat to plot_dsd_scat to avoid conflicts
...
pro plot_dsd_scat, pos, sub_title, siteID, ncolor, charsz, xdata, ydata, ndata, $
  ...
  for j=0,1 do begin   ;column, count from left; also, strat/conv raintype index
    ...
    IF ( npts[0] GT 0 ) THEN BEGIN
      ...
      IF ( nfound GT 0 ) THEN BEGIN
         ...
         plot_dsd_scat, pos, subtitle, siteID, ncolor, charsz, gvsub, prsub, nfound, $
      ...
      ENDIF ELSE BEGIN
         ...
         plot_dsd_scat, pos, subtitle, siteID, ncolor, charsz, S2KU=s2ku4sca, $
