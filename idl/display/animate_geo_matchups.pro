...
if(cpstatus eq 'OK') then begin
  ...
  status = read_geo_match_netcdf( ncfile1, matchupmeta=mygeometa, $
    sweepsmeta=mysweeps, sitemeta=mysite, fieldflags=myflags, pridx_long=pr_index, $
  ...
  goto, errorExit
endelse
PRINT, "Site Elevation: ", mysite.site_elev
...
;xinteranimate, set=[xsize, ysize*2, 2], /TRACK
