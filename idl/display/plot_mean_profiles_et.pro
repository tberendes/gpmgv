pro plot_mean_profiles_et, file, plotlabel, INSTRUMENT=instrument
...
plot, [15,45], [hgtarr[0],20 < prop_max_y], /NODATA, COLOR = 0, $
  ...
  ; plot profiles without a break at height 0.0
   ...
   ENDIF ELSE BEGIN
      IF nlev2plot EQ 1 THEN BEGIN
         ...
         proff = offsetbar*2 
         groff = offsetbar
         oplot, prmnarr[idx2plot], h2plot[idx2plot]+proff, COLOR = 20, $
             psym=6, symsize=1
         oplot, grmnarr[idx2plot], h2plot[idx2plot]+groff, COLOR = 70, $
             psym=6, symsize=1
      ENDIF
   ENDELSE
  ...
  ; plot the profile for stratiform rain type points
   ...
   ENDIF ELSE BEGIN
      IF nlev2plots EQ 1 THEN BEGIN
         ...
         proff = offsetbar*2 
         groff = offsetbar
         oplot, sprmnarr[idx2plot], h2plot[idx2plot]+proff, COLOR = 20, $
             psym=4, symsize=1
         oplot, sgrmnarr[idx2plot], h2plot[idx2plot]+groff, COLOR = 70, $
             psym=4, symsize=1
      ENDIF
   ENDELSE
  ...
  ; plot the profile for convective rain type points
   ...
   ENDIF ELSE BEGIN
      IF nlev2plotc EQ 1 THEN BEGIN
         ...
         proff = offsetbar*2 
         groff = offsetbar
         oplot, cprmnarr[idx2plot], h2plot[idx2plot]+proff, COLOR = 20, $
             psym=1, symsize=1
         oplot, cgrmnarr[idx2plot], h2plot[idx2plot]+groff, COLOR = 70, $
             psym=1, symsize=1
      ENDIF
   ENDELSE
