...
if(cpstatus eq 'OK') then begin
  ...
  status = read_geo_match_netcdf( ncfile1, matchupmeta=mygeometa, $
    ...
    raintype_int=rnType, sfctype_int=sfctyp, $
    sfcrainpr=sfcrain, sfcraincomb=sfcraincomb, bbhgt=BB, $
    rainflag_int=rnFlag )
...
idxtyp=where(rntype lt 100) & rntype[idxtyp] = 0
rntype = rntype/5
BB=BB/5.0
...
mygvbuf = plot_sweep_2_zbuf( BB, mysite.site_lat, mysite.site_lon, xCorner, $
                             yCorner, mygeometa.num_footprints, 0, $
