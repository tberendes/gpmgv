...
pro rr_comparisons_driver_dw, CONTROL_FILE=ctlfile
...
IF STRMATCH( sitefilter, 'GRtoTMI*' ) NE 1 THEN BEGIN
HELP, sitefilter
   print, "Changing SITE specification from ", sitefilter, " to ", 'GRtoTMI*'+sitefilter
   sitefilter='GRtoTMI*'+sitefilter
ENDIF

tmi2gr_rainrate_comparisons_wolff, SPEED=looprate, $
                             ELEVS2SHOW=elevs2show, $
                             NCPATH=ncpath, $
                             SITE=sitefilter, $
                             NO_PROMPT=no_prompt, $
