...
PRO plot_event_series_stacked, file, NSMOOTH=nsmooth
...
PLOT, x_date_arr, y_mean_arr, XRANGE=x_range, YRANGE=[-4.5,4.5], XSTYLE=1, ystyle = 1, $
      /nodata, BACKGROUND=1, COLOR=0, ycharsize=1.5, xcharsize=0.1, xticks=1, xtickformat='(I1)'
