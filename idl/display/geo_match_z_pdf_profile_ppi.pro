...
; All Rights Reserved.
;
; geo_match_z_pdf_profile_ppi.pro         Morris/SAIC/GPM_GV      November 2008
;
; DESCRIPTION
; -----------
...
;                parameter. If unset, defaults to horizontal
...
;-
;===============================================================================
pro geo_match_z_pdf_profile_ppi, PDF_LEVEL=pdf_level, SPEED=looprate, $
...
mnprarr = fltarr(3,13)  ; all 13 levels, for 3 raintypes: all, stratiform, convective
mngvarr = fltarr(3,13)  ; ditto
