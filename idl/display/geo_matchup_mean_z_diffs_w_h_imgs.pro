pro geo_matchup_mean_z_diffs_w_h_imgs, PDF_LEVEL=pdf_level, SPEED=looprate, $
...
; set up the height level to show in e PDF plot
...
;window, 1, xsize=xsize, ysize=ysize*2, xpos = 75, TITLE = title, PIXMAP=do_pixmap

; instantiate animation widget
;IF nframes GT 1 THEN xinteranimate, set=[xsize, ysize*2, nframes], /TRACK
...
SET_PLOT, 'X'
device, decomposed=0
window, ifram+1, xsize=xsize*2, ysize=ysize, xpos = 75, TITLE = title, PIXMAP=do_pixmap, RETAIN=2
TV, myprbuf, 0
TV, mygvbuf, 1
