...
; All Rights Reserved.
;
; tmi2gr_rainrate_comparisons_driver.pro
;
; DESCRIPTION
; -----------
; Reads a file containing a set of parameters to be used to run the procedure
; tmi2gr_rainrate_comparisons, parses the options specified in
...
; INTERNAL MODULES
; ----------------
; 1) tmi2gr_rainrate_comparisons_driver - Main driver procedure called by user
; 2) parse_pdf_sca_parms - Parses the control file to get keyword parameters
;
; HISTORY
; -------
; 01/15/14 Morris, GPM GV, SAIC
; - Created from z_comparisons_driver.pro.
;
;
...
FUNCTION parse_pdf_sca_parms, ctlstr, looprate, elevs2show, ncpath, sitefilter, $
                              ...
                              pop_threshold, show_thresh_ppi, hide_totals, $
...
pro tmi2gr_rainrate_comparisons_driver, CONTROL_FILE=ctlfile
...
IF (runhelp EQ 1) THEN BEGIN
   print, ''
   print, 'Dumping variables from tmi2gr_rainrate_comparisons_driver procedure:'
   print, ''
   help, NAMES='*' & print, ''
ENDIF
