...
IF KEYWORD_SET(cappi_anim) THEN cappi_heights = heights[0:8]
...
pro dpr_cmb_and_geo_match_x_sections, ELEV2SHOW=elev2show, SITE=sitefilter, $
...
print
print, "###############################################"
print, "#  DPR_AND_GEO_MATCH_X_SECTIONS: Version 3.0  #"
print, "#  NASA/GSFC/GPM Ground Validation, May 2016  #"
print, "###############################################"
print
