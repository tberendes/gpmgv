...
z_rain_dsd_profile_scatter_all, INSTRUMENT='DPRGMI', KUKA=KuKa, SCANTYPE=swath, $
   ...
   FILEP='GRtoDPRGMI.K*.1_3.*nc.gz', VERSION2MATCH=version2match, $
   ...
   PROFILE_SAVE='/tmp/AGL_Profiles.' + nameAdd + '.DPRNS.sav'
