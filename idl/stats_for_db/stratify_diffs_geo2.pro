...
; All Rights Reserved.
;
;  stratify_diffs_geo2.pro   Morris/SAIC/GPM_GV      October 2008
;
;  SYNOPSIS:
;  stratify_diffs_geo2, prdbz, gvdbz, raintype, bb, gvzmax, gvzstddev, stats_by_cat
;
;  DESCRIPTION:
...
pro stratify_diffs_geo2, prdbz, gvdbz, raintype, bb, gvzmax, gvzstddev, stats_by_cat
