...
; All Rights Reserved.
;
; testreaddprgeomatchnetcdf_phase_v88.pro           Morris/SAIC/GPM_GV      July 2013
;
; DESCRIPTION
; -----------
; Test driver for function read_dpr_geo_match_netcdf_phase_v88.pro
;
...
pro testreaddprgeomatchnetcdf_phase_v88, mygeomatchfile
...
if n_elements(mygeomatchfile) eq 0 then begin
   ...
   mygeomatchfile=dialog_pickfile(FILTER=filters, $
       ...
       PATH='/data/gpmgv/netcdf/geo_match/GPM/2ADPR/NS/V05A/8_8')
...
if(cpstatus eq 'OK') then begin
  ...
  status = read_dpr_geo_match_netcdf_phase_v88( myfile, matchupmeta=mygeometa, $
 ...
 ; create data field arrays of correct dimensions and read data fields
  ...
  status = read_dpr_geo_match_netcdf_phase_v88( myfile, $
   ...
   ; DPR science values at earth surface level, or as ray summaries:
    ...
    clutterStatus_int=clutterStatus, phase_int=phase,                         $
