...
; All Rights Reserved.
;
; read_2agprof_hdf5_v7.pro         Bob Morris, GPM GV/SAIC   October 2014
;
; DESCRIPTION
...
FUNCTION read_2agprof_hdf5_v7, file, DEBUG=debug, READ_ALL=read_all
...
;         print, dtval[0]
   ...
   for isw = 0, filestruc.NUMBEROFSWATHS-1 do begin
      ...
      *ptr_datasets = get_2agprofgmi_datasets_v7(sw_group_id, prodgroup, $
                                              READ_ALL=all)
