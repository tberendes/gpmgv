...
; All Rights Reserved.
;
; get_dpr_pre_group_v7.pro         Bob Morris, GPM GV/SAIC   May 2013
;
; DESCRIPTION
...
; - Added new GPM V7 Variable Height
;
; EMAIL QUESTIONS OR COMMENTS AT:
;       https://pmm.nasa.gov/contact
;-

FUNCTION get_dpr_pre_group_v7, group_id, prodgroup, READ_ALL=read_all
