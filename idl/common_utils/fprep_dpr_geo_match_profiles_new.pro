...
FUNCTION fprep_dpr_geo_match_profiles_new, ncfilepr, heights_in, $
...
stop
 ...
 ; 2nd call to read_dpr_geo_match_netcdf_new()
   CATCH, error
   IF error EQ 0 THEN BEGIN
      status = read_dpr_geo_match_netcdf_new( ncfile1, matchupmeta=mygeometa, $
                                              DIMS_ONLY=1 )
   ENDIF ELSE BEGIN
      help,!error_state,/st
      Catch, /Cancel
