...
################################################################################
#
#  catalogQCradarCpol_gpm.sh     Morris/SAIC/GPM GV     July 2015
#
#  DESCRIPTION
#    
...
#
#  HISTORY
#    07/23/2015, Morris, GPM GV
#    - Created from baseline catalogQCradar.sh script, modified to do specific
#      years for a specific site only (currently DARW/CPol).
#
################################################################################
...
for Kxxx in DARW              # for makeup cataloging, just do one site
  do
    echo "" | tee -a $LOG_FILE
