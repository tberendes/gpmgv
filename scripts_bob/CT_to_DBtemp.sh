...
# sed command 5: delete all lines where radar code isn't like 'Kxxx'
# sed command 6: delete all lines where radar code is 'KORA'
...
s/  */|/g
s/\([0-9]\)T\([0-9]\)/\1 \2/g
/^[0-9][0-9]*|Ground_Radar_|K[A-Z]\{3\}/ !d
/^[0-9][0-9]*|Ground_Radar_|KORA/ d
