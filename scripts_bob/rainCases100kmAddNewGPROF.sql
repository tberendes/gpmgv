...
from overpass_event a
    JOIN event_meta_numeric_copy b ON a.event_num = b.event_num AND b.metadata_id = 250199
    JOIN event_meta_numeric_copy c ON a.event_num = c.event_num AND c.metadata_id = 230102
    JOIN event_meta_numeric_copy d ON a.event_num = d.event_num AND d.metadata_id = 230101
    JOIN event_meta_numeric_copy e ON a.event_num = e.event_num AND e.metadata_id = 251105 and e.value >= 100 order by 4;
