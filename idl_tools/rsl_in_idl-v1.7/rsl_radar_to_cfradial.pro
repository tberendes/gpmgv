...
;     DAT2D:
;         Set this keyword to store data into CfRadial in 2-D array.  By
;         default it is stored in 1-D array.
;     GZIP: 
...
pro rsl_radar_to_cfradial, radar, cfradfile, fields=fields, gzip=gzip, $
    catch_error=catch_error, dat2d=dat2d
...
ncdf_attput,cfid,nyqid,'units','meters_per_second'
...
; VCP 121 split cuts.
extra_vel = where(stregex(fieldlist,'V[R23]|S[W23]',/boolean),count)
