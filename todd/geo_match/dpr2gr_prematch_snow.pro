...
; All Rights Reserved.
;
; dpr2gr_prematch_snow.pro          Morris/SAIC/GPM_GV      March 2016
;
; DESCRIPTION
; -----------
...
;   2) PROCEDURE dpr2gr_prematch_scan_snow    (this file)
;   3) PROCEDURE dpr2gr_prematch_snow         (this file)
;
;
; CONSTRAINTS
; -----------
...
;         as the NC_NAME_ADD parameter value for dpr2gr_prematch_snow().
;
;
; HISTORY
; -------
...
PRO dpr2gr_prematch_scan_snow, dpr_data, data_GR2DPR, dataGR, DPR_scantype, $
...
PRO dpr2gr_prematch_snow, control_file, GPM_ROOT=gpmroot, DIRDPR=dir2adpr, $
        ...
        ; check for the case of no footprints for the swath
         IF data_GR2DPR.NUMRAYS GT 0 THEN BEGIN
           ...
           ; generate the GRtoDPR netcdf matchup file path/name
            ...
            dpr2gr_prematch_scan_snow, dpr_data, data_GR2DPR, dataGR, DPR_scantype, $
               DPR_version, mygeometa, mysweeps, mysite, myflags, myfiles, $
               grverstr, Instrument_ID, infileNameArr, fname_netCDF, $
               PLOT_PPIS=plot_PPIs, SCORES=run_scores, $
               NC_DIR=nc_dir, FLAT_NCPATH=flat_ncpath, NC_NAME_ADD=ncnameadd, $
