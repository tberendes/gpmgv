...
;-------------------------------------------------------------------------------
;
; gen_gr_hsmsns_geo_match_netcdf_snow.pro    Bob Morris, GPM GV (SAIC)    Feb 2016
;
; DESCRIPTION:
...
FUNCTION gen_gr_hsmsns_geo_match_netcdf_snow, geo_match_nc_file, numpts_HS, numpts_MS, $
