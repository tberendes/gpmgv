...
; All Rights Reserved.
;
; select_geomatch_subarea_mrms.pro       Morris/SAIC/GPM_GV    April 2015
;
; DESCRIPTION
; -----------
...
; 9/4/18 Berendes, UAH
; - created this copy for eventual MRMS and SWERR uses, need to enable subsetting 
;   for MRMS and snow mods, currently this does nothing with those fields
;
;
...
FUNCTION select_geomatch_subarea_mrms, hide_rntype, pr_or_dpr, elev2show, $
