...
;-------------------------------------------------------------------------------
;
; gen_geo_match_netcdf_csu.pro    Bob Morris, GPM GV (SAIC)    September 2008
;
; DESCRIPTION:
...
; 11/27/2009  Morris           Created from gen_geo_match_netcdf.  Added GV
;                              attenuation variable.
;-------------------------------------------------------------------------------
;-

FUNCTION gen_geo_match_netcdf_csu, geo_match_nc_file, numpts, elev_angles, $
                               gv_UF_field, PR_vers
...
haveattgvvarid = ncdf_vardef(cdfid, 'have_GR_attenuation', /short)
ncdf_attput, cdfid, haveattgvvarid, 'long_name', $
             'data exists flag for GR attenuation'
ncdf_attput, cdfid, haveattgvvarid, '_FillValue', 1

haveattmaxvarid = ncdf_vardef(cdfid, 'have_max_GR_attenuation', /short)
ncdf_attput, cdfid, haveattmaxvarid, 'long_name', $
             'data exists flag for max GR attenuation'
ncdf_attput, cdfid, haveattmaxvarid, '_FillValue', 1
...
ncdf_attput, cdfid, topvarid, 'long_name', 'data sample top height'
...
ncdf_attput, cdfid, botmvarid, 'long_name', 'data sample bottom height'
...
dbzgvvarid = ncdf_vardef(cdfid, 'GR_attenuation', [fpdimid,eldimid])
ncdf_attput, cdfid, dbzgvvarid, 'long_name', 'GV radar path integrated attenuation'
ncdf_attput, cdfid, dbzgvvarid, 'units', 'dBZ'
ncdf_attput, cdfid, dbzgvvarid, '_FillValue', FLOAT_RANGE_EDGE

dbzgvvarid = ncdf_vardef(cdfid, 'max_GR_attenuation', [fpdimid,eldimid])
ncdf_attput, cdfid, dbzgvvarid, 'long_name', 'maximum GV radar path integrated attenuation'
ncdf_attput, cdfid, dbzgvvarid, 'units', 'dBZ'
ncdf_attput, cdfid, dbzgvvarid, '_FillValue', FLOAT_RANGE_EDGE
