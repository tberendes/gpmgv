...
restore, '/home/morris/swdev/idl/dev/geo_match/polar2dpr_hs_ms_ns.sav'
...
;resolve_all
;save, /routines, file='/home/morris/swdev/idl/dev/geo_match/polar2dpr_hs_ms_ns.sav'
