...
pro read_2a54, filename, STORMTYPE=convStratFlag, hour, minute, second
...
IF keyword_set(convStratFlag) THEN BEGIN
 
;start = [0,0,0,0]
;count = [151,151,13,11]
;stride = [1,1,1,1]

sds_id=HDF_SD_SELECT(sd_id,hdf_sd_nametoindex(sd_id,'convStratFlag'))
HDF_SD_GETDATA, sds_id, convStratFlag
