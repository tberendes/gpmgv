...
pro plot_dpr_xsection_bb, scanNumpr, raystartpr, rayendpr, z_data, meanbb, $
...
; get rid of 3rd dimension of size 1, and flip vertically to put bins in
; ascending height order
xsect2d = REVERSE( REFORM( xsect2d ), 1 )
arsize = SIZE( xsect2d )
print, 'arsize: ', arsize
