...
IF KEYWORD_SET(rhi_mode) THEN modeStr='_RadialStep' ELSE modeStr='_ScanStep'
...
; SHOULD PUT THIS BLOCK INTO A FUNCTION
   ...
   idxedges = WHERE(fpdist GT (mygeometa.rangeThreshold-2.0), countedges)
   pr_index_edges1 = pr_index_slice[idxedges]
   ; compute the azimuths of these samples
   azedges = (180./!pi*atan(xfpctr[idxedges],yfpctr[idxedges]) + 360.) MOD 360.
         ...
         250B : BEGIN
                   ...
                   IF KEYWORD_SET(rhi_mode) THEN BEGIN
                     ...
                     ; for sizing the geo-match and DPR cross section windows
                      ...
                      startend2show = [0, maxFPradials-1]
                   ENDIF ELSE BEGIN
...
pro dpr_and_geo_match_x_sections_rhi_loop, ELEV2SHOW=elev2show, SITE=sitefilter, $
