PRO agu_nexrad_bias_maps_pr_dpr, PR_DPR_diffs_file, PSNAMEADD=psNameAdd
...
WHILE ~ EOF(unit) DO BEGIN
   ...
   radar_names_array[num] = parsed2[0]
...
for isource = 0,2 do begin
   CASE isource OF
      ...
      1 : begin
          sym2 = sym_string_post
          print, "Plotting DPR bias"
          cbarTitle = 'GR-DPR mean differences (dBZ), DPR'
          end
      2 : begin
          sym2 = sym_string_chg
          print, "Plotting PR-DPR bias change"
...
PRINT, 'finished making map!!  See graphics file ', outfilePDF
skip:
END
