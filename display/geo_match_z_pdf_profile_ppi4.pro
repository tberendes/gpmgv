...
;-
;===============================================================================
pro geo_match_z_pdf_profile_ppi4, PDF_LEVEL=pdf_level, SPEED=looprate, $
   ...
   if nf eq 0 then begin
      ...
      for fnum = 0, nf-1 do begin
         ...
         action=geo_match_z_plots( ncfilepr, height, looprate, elevs2show, $
                                   PPIorient, ppi_size, pctAbvThresh )
...
IF ( count2blank GT 0 ) THEN BEGIN
  gvz_in[idx2blank] = 0.0
  zcor_in[idx2blank] = 0.0
ENDIF
