...
; All Rights Reserved.
;
; geo_match_z_pdf_profile_ppi6.pro         Morris/SAIC/GPM_GV      November 2008
;
; DESCRIPTION
; -----------
...
;-
;===============================================================================
pro geo_match_z_pdf_profile_ppi6, PDF_LEVEL=pdf_level, SPEED=looprate, $
...
;  Using GV dBZ thresholds of >=35 for "GV Convective" and <=25 for "GV Stratiform",
...
;  25 and 35 dBZ, leave the PR rain type as-is.
...
print, "No. of footprints switched from Convective to Other: ", count2other
idx2other = WHERE( rnType EQ 1 AND max_gvz_per_fp GE 35.0, count2other )
IF ( count2other GT 0 ) THEN rnType[idx2other] = 3
print, "No. of footprints switched from Stratiform to Other: ", count2other
