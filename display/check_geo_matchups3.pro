...
; All Rights Reserved.
;
; check_geo_matchups3.pro         Morris/SAIC/GPM_GV      February 2009
;
;
; DESCRIPTION
; Reads PR reflectivity and spatial fields from a user-selected geo_match
; netCDF file, and GV reflectivity from the matching 1C-UF radar file, plots a
; PPI for each, and builds an animation loop of the data over the elevation
...
pro check_geo_matchups3, SPEED=looprate, ELEVS2SHOW=elevs2show, NCPATH=ncpath, $
...
@environs.inc
; ***************************** Local configuration ****************************
in_base_dir = '/data/gv_radar/finalQC_in/'  ; default root dir for UF files
...
ufpath = in_base_dir+site+'/'+'1CUF'+addcal+'/'+year+'/'+mmdd+'/'
