pro plot_mean_profiles, file, plotlabel, INSTRUMENT=instrument

; DESCRIPTION
; -----------
; Uses old-style IDL graphics to plot mean vertical profiles from profile data
; written to a text file by a bulk statistical analysis procedure such as
; stats_by_dist_to_dbfile_dpr_pr_geo_match.  Plots both satellite and GR
; profiles for 3 rain type categories: stratiform, convective, and any.
;
; HISTORY
; -------
