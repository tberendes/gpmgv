...
;   device, decomposed = 0, retain = 1
;endif
if (do_ps ne 1) then Window, 1, xsize=500, ysize=500, XPOS = 600, YPOS = 0, TITLE = '2A-54 Rain Type'
...
if (do_ps ne 1) then Window, 2, xsize=500, ysize=500, XPOS = 1200, YPOS = 0, TITLE = '2A-53 Rain Rate'
